  ...
  <div class="flex justify-center items-center h-full w-screen ">
    <div class="flex flex-col justify-items-center bg-gray-800 h-screen w-3/6 p-12">
      <h1 class="text-white flex justify-center">
        Bem-vindo a explicação sobre array!
      </h1>
      <br />
      <h2 class="text-white flex justify-center">O que é um array:</h2>
      <p class="text-white mt-4">
        Um array é como uma caixa com vários compartimentos, cada um guardando
        algo, como brinquedos. Na programação, chamamos esses compartimentos
        de "elementos", e cada elemento tem um número que indica sua posição,
        começando do zero.
      </p>
      <br />
      <h2 class="text-white flex justify-center">Como criar um array:</h2>
      <p class="text-white flex justify-center mt-4">
        Imagine uma lista de amigos e quer guardar o nome de cada um. Crie um
        array chamado nomes dos amigos, onde cada amigo tem seu próprio
        compartimento.
      </p>
