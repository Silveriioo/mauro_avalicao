  ...
  <div class="flex justify-center items-center h-full w-screen ">
    <div class="flex flex-col justify-items-center bg-gray-800 h-screen w-3/6 p-12">
      <h1 class="text-white flex justify-center">
        Bem-vindo a explicação sobre árvore!
      </h1>
      <br />
      <h2 class="text-white flex justify-center">O que é um árvore:</h2>
      <p class="text-white mt-4">
        Uma árvore na programação é uma estrutura que se assemelha a uma árvore da vida. Tem um ponto inicial chamado "raiz" e ramifica em diferentes "galhos" ou "nós". Cada nó pode ter seus próprios ramos, criando uma estrutura hierárquica.
      </p>
      <br />
      <h2 class="text-white flex justify-center">Como criar um árvore:</h2>
      <p class="text-white flex justify-center mt-4">
        Pense em organizar categorias em um diretório de arquivos. A pasta principal seria a "raiz" e cada subpasta seria um "nó". Dentro de cada subpasta, pode haver mais subpastas, formando uma árvore de categorias e subcategorias.
      </p>
      <!-- Conteudo -->
