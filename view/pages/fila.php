  ...
  <div class="flex justify-center items-center h-full w-screen ">
    <div class="flex flex-col justify-items-center bg-gray-800 h-screen w-3/6 p-12">
      <h1 class="text-white flex justify-center">
        Bem-vindo a explicação sobre fila!
      </h1>
      <br />
      <h2 class="text-white flex justify-center">O que é um fila:</h2>
      <p class="text-white mt-4">
        Uma fila na programação é como uma fila no mercado. As pessoas que chegaram primeiro são atendidas primeiro. Na programação, uma fila segue o mesmo princípio: o primeiro elemento a entrar é o primeiro a ser processado.
      </p>
      <br />
      <h2 class="text-white flex justify-center">Como criar um fila:</h2>
      <p class="text-white flex justify-center mt-4">
        Imagine uma fila de espera em uma montanha-russa. As pessoas se alinham e o primeiro que chegou é o primeiro a embarcar. Em programação, você pode criar uma fila chamada, por exemplo, filaDeClientes, e adicionar clientes a ela. O primeiro cliente adicionado será o primeiro a ser atendido.
      </p>
