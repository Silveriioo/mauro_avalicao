  ...
  <div class="flex justify-center items-center h-full w-screen ">
    <div class="flex flex-col justify-items-center bg-gray-800 h-screen w-3/6 p-12">
      <h1 class="text-white flex justify-center">
        Bem-vindo a explicação sobre matrix!
      </h1>
      <br />
      <h2 class="text-white flex justify-center">O que é um matrix:</h2>
      <p class="text-white mt-4">
        Em programação, uma matriz é uma estrutura de dados que organiza elementos em linhas e colunas. Cada elemento é identificado por dois índices: um para a linha e outro para a coluna. Matrizes são frequentemente usadas para representar dados tabulares, como grades de números.      
      </p>
        <br />
      <h2 class="text-white flex justify-center">Como criar um matrix:</h2>
      <p class="text-white flex justify-center mt-4">
        Pense em uma folha de papel quadriculada. Cada célula na grade pode conter um valor específico. Em programação, você pode criar uma matriz definindo arrays aninhados, onde cada array interno representa uma linha e os elementos desse array são os valores nas colunas.      
      </p>
