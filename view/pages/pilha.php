  ...
  <div class="flex justify-center items-center h-full w-screen ">
    <div class="flex flex-col justify-items-center bg-gray-800 h-screen w-3/6 p-12">
      <h1 class="text-white flex justify-center">
        Bem-vindo a explicação sobre pilha!
      </h1>
      <br />
      <h2 class="text-white flex justify-center">O que é um pilha:</h2>
      <p class="text-white mt-4">
        Em programação, uma pilha é uma estrutura de dados que segue o princípio "último a entrar, primeiro a sair" (LIFO - Last In, First Out). Isso significa que o último elemento adicionado é o primeiro a ser removido.      </p>
        <br />
      <h2 class="text-white flex justify-center">Como criar um pilha:</h2>
      <p class="text-white flex justify-center mt-4">
        Pense em uma pilha de pratos. Você adiciona um prato no topo e retira do topo. Em programação, você pode criar uma pilha usando um array e operações como push para adicionar elementos no topo e pop para removê-los.      </p>
